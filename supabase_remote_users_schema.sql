-- ====================================================================
-- SUPABASE DATABASE SCHEMA MIGRATION: REMOTE USERS TABLE
-- Persistent Remote Monitoring & Screen Supervision Management
-- ====================================================================
...
-- 4. Initial Seed of Existing Remote Team Members into remote_users
INSERT INTO remote_users (user_email, user_name, department, designation, role, status, is_active)
VALUES 
('sara.design@gmail.com', 'Sara Khan', 'UI/UX Design', 'Remote Member', 'employee', 'active', true),
('rahim.dev@gmail.com', 'Rahim Bugti', 'Software Engineering', 'Remote Member', 'employee', 'active', true),
('ali.staff@gmail.com', 'Ali Staff', 'Software Engineering', 'Remote Member', 'employee', 'active', true),
('student@gmail.com', 'Ali Hassan', 'Full Stack MERN Web Development', 'Remote Student', 'student', 'active', true)
